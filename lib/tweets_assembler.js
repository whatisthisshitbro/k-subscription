...
var Renderer = {
  ...
  renderTweet: function (tweet, useColors, nameAttribute) {
    ...
    var tweetClass = 'k-subscription_tweet tweet';
      ...
      actions: [
        ...
        },
        {
          ...
          condition: function() {
			...
			return !followingUsers.hasOwnProperty(username);
          }
        },
        {
  ...
  assemblyTweetsOnPage: function (tweets, nameAttribute, fadeTimeout) {
    ...
    var existingDestination = $("#k-subscription_container");
    if(existingDestination.length == 1) {
      existingDestination.append(tweetsArray);
    } else {
      var destination = $('<div id="k-subscription_container">'),
          controlBar = $('<div id="k-subscription_control">'),
